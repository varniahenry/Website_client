export default function PrivacyPolicyPage() {
  return (
    <div className='max-w-screen-xl m-auto px-10 copy pb-10'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Varnia Henry&apos;s Website.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Varnia Henry&apos;s Website,
            accessible from{' '}
            <a
              href='notknown'
      ...
      <ul>
        <li>By email: varniahenry@gmail.com</li>
      </ul>
    </div>
  );
}
